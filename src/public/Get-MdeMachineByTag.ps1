...
.DESCRIPTION
  Find Machines by Tag. The optional parameter useStartsWithFilter sets the matching to lazy matching the start of the machine name. E.g. -tag 'tag-' will match 'tag-1', 'tag-123', etc.. 

.NOTES
  Author: Jan-Henrik Damaschke

.LINK
  https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/find-machines-by-tag?view=o365-worldwide
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUru4G25gfBON6VJ5E4BlLnyu8
# 5V2gghHrMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSEmg/eRCfBXjTaOMslzzZUIyJS4jANBgkq
# hkiG9w0BAQEFAASCAgCktzsP7hrVSo8GPqhOF0Hqg/MBMXgAPrlUUYwdqBk0Y/W8
# jdZAtPEFgfEt0OZcAsNNDxcwgrXOgBtA4xP5wkx7Sfdfg4h9p+HPFEfBn1s4jc1o
# WiAOnIU1A/WMZPL/RPb/nhQiaL5HlgB+Vg9a7z91iOExpy00jJEP5KwGWRVpIF1u
# 3pe/uT5D30qK0mK7XkzQblKJO/3N2de4ZUKuJjY4NMVZE6NpWmvXSsUclKlRfqtj
# io9aYdRrKdlLawu1PjXJ1J968hHGH4yzvj4FGE5wSFvHIATfID9d98rJIiOPGeZI
# HwAS/e9U/weKNSXZPytkRC7YVQREEpkylyB83B+1ikBPPcY8AEzdU8Q63J/GSCy6
# 5Q/zlc/As+tdQB4hgoy+fwkk/3hcMrjbcnlFZIvnj8AGeJqWAE6SmJpyy8f7fcFB
# +HmqpCbr+luuH6YHr3VSigFeA/+Lc1edpXeqM72bVa8fUbpCuI18kxI2btRGIaCT
# +wH7fPPy9xBcjtX5EKUmOv75sKwvxegFePvb9DKIOrOf0ZNMsYqaj04zLou8XG/7
# hIX0RbyR9JODqJnFryRg5G2rTUe7OrPzbbzauBDmrcvDk6bfLESHG0Ty1Y2nVdkk
# nnGTyQD4UXrAaWD94RC5teQW7oDUPOeNFVU5JgaXjnTC3xuzGbZ8GML/Lj9OHQ==
