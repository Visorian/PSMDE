...
Describe "Get-MdeRemediationTask" {
  ...
  It 'Should correctly create the request uri' {
    InModuleScope PSMDE {
      ...
      $id = '12345'
      Get-MdeRemediationTask | Should -Be "https://api.securitycenter.microsoft.com/api/remediationtasks"
      Get-MdeRemediationTask -id $id | Should -Be "https://api.securitycenter.microsoft.com/api/remediationtasks/$id"
    }
  }
}