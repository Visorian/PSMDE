...
Describe "Get-MdeRecommendationVulnerabilities" {
  ...
  It 'Should correctly create the request uri' {
    InModuleScope PSMDE {
      ...
      $id = '12345'
      Get-MdeRecommendationVulnerabilities -id $id | Should -Be "https://api.securitycenter.microsoft.com/api/recommendations/$id/vulnerabilities"
    }
  }
}