...
Describe "Get-MdeMachineRecommendations" {
  ...
  It 'Should correctly create the request uri' {
    InModuleScope PSMDE {
      ...
      $id = '12345'
      Get-MdeMachineRecommendations -id $id | Should -Be "https://api.securitycenter.microsoft.com/api/machines/$id/recommendations"
    }
  }
}