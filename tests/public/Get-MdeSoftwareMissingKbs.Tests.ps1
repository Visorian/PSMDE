...
Describe "Get-MdeSoftwareMissingKbs" {
  ...
  It 'Should call Invoke-AzureRequest when id parameter is provided' {
    InModuleScope PSMDE {
      ...
      Get-MdeSoftwareMissingKbs -id '123'
  ...
  It 'Should correctly create the request uri' {
    InModuleScope PSMDE {
      ...
      Get-MdeSoftwareMissingKbs -id $id | Should -Be "https://api.securitycenter.microsoft.com/api/Software/$id/getmissingkbs"
    }
  }
}