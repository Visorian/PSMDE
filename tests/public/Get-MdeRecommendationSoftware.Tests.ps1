...
Describe "Get-MdeRecommendationSoftware" {
  ...
  It 'Should correctly create the request uri' {
    InModuleScope PSMDE {
      ...
      $id = '12345'
      Get-MdeRecommendationSoftware -id $id | Should -Be "https://api.securitycenter.microsoft.com/api/recommendations/$id/software"
    }
  }
}